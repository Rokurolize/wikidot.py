...
This slice does not add `iter_sources(...)`, source batch fallback, or structured per-page source failure records. Those remain in the broader large-corpus feature draft.
