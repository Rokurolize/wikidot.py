...
- Keep using `Page.create_or_edit()`, `Page.refresh_source()`, and `Page.set_metadata()` separately. Local commit `087312d` now wraps these primitives in `site.page.publish(...)` for the common workflow, and local commit `ebb3434` adds an opt-in source normalization hook for verification. Explicit post-save visibility polling remains a broader design choice.
...
The first helper slice is drafted in [017-pr-browser-free-page-publish-helper.md](017-pr-browser-free-page-publish-helper.md), and the source normalization follow-up is drafted in [020-pr-publish-source-verification-normalizer.md](020-pr-publish-source-verification-normalizer.md). Remaining follow-up decisions include whether to add explicit post-save visibility polling or more detailed per-operation result statuses. This feature area is larger than the small batching PRs in [002-pr-batch-source-page-id-lookups.md](002-pr-batch-source-page-id-lookups.md), [007-pr-batch-meta-tag-updates.md](007-pr-batch-meta-tag-updates.md), [011-pr-robust-meta-tag-parsing.md](011-pr-robust-meta-tag-parsing.md), [012-pr-batch-page-metadata-updates.md](012-pr-batch-page-metadata-updates.md), [013-pr-refresh-cached-page-source.md](013-pr-refresh-cached-page-source.md), [014-pr-preserve-viewsource-text.md](014-pr-preserve-viewsource-text.md), [017-pr-browser-free-page-publish-helper.md](017-pr-browser-free-page-publish-helper.md), and [020-pr-publish-source-verification-normalizer.md](020-pr-publish-source-verification-normalizer.md).
