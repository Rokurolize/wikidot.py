...
- The local hardening commit `41c1639` fixed several edge cases this helper would rely on, local commit `d2a6fe6` added a smaller `Page.set_metadata()` slice for the post-save metadata phase, local commit `ada455f` added `Page.refresh_source()` for source round-trip checks, and local commit `f89b170` preserved multiline view-source text fidelity for those checks.

## Additional Information

This should be filed as a feature issue before implementation. It is larger than the small batching PRs in [002-pr-batch-source-page-id-lookups.md](002-pr-batch-source-page-id-lookups.md), [007-pr-batch-meta-tag-updates.md](007-pr-batch-meta-tag-updates.md), [011-pr-robust-meta-tag-parsing.md](011-pr-robust-meta-tag-parsing.md), [012-pr-batch-page-metadata-updates.md](012-pr-batch-page-metadata-updates.md), [013-pr-refresh-cached-page-source.md](013-pr-refresh-cached-page-source.md), and [014-pr-preserve-viewsource-text.md](014-pr-preserve-viewsource-text.md).
