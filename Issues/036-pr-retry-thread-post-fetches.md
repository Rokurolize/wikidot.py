...
Follow-up [081-pr-ignore-forum-content-pseudo-posts.md](081-pr-ignore-forum-content-pseudo-posts.md) keeps this retry-aware post-list read path but narrows forum post parsing to real `post-container` children so content pseudo-post markup is ignored. Follow-up [082-pr-ignore-content-edit-metadata.md](082-pr-ignore-content-edit-metadata.md) further scopes forum edit metadata parsing so content `div.changes` markup cannot create false `edited_by` or `edited_at` values. Follow-up [083-pr-ignore-content-post-containers.md](083-pr-ignore-content-post-containers.md) rejects complete content-embedded `post-container` fragments before field parsing.
