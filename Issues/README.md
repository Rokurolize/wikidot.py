...
- [689-pr-validate-site-application-constructor-user-id-range.md](689-pr-validate-site-application-constructor-user-id-range.md): upstream PR draft for the committed site application constructor user ID range validation fix.
- [690-pr-validate-site-member-constructor-user-id-range.md](690-pr-validate-site-member-constructor-user-id-range.md): upstream PR draft for the committed site member constructor user ID range validation fix.
- [691-pr-validate-page-vote-constructor-user-id-state.md](691-pr-validate-page-vote-constructor-user-id-state.md): upstream PR draft for the committed page vote constructor user ID state validation fix.
- [692-pr-validate-private-message-constructor-user-id-state.md](692-pr-validate-private-message-constructor-user-id-state.md): upstream PR draft for the committed private message constructor participant user ID state validation fix.
- [693-pr-validate-site-change-actor-user-id-state.md](693-pr-validate-site-change-actor-user-id-state.md): upstream PR draft for the committed SiteChange constructor actor user ID state validation fix.
- [694-pr-validate-page-revision-creator-user-id-state.md](694-pr-validate-page-revision-creator-user-id-state.md): upstream PR draft for the committed PageRevision constructor creator user ID state validation fix.
- [695-pr-validate-forum-thread-creator-user-id-state.md](695-pr-validate-forum-thread-creator-user-id-state.md): upstream PR draft for the committed ForumThread constructor creator user ID state validation fix.
- [696-pr-validate-forum-post-actor-user-id-state.md](696-pr-validate-forum-post-actor-user-id-state.md): upstream PR draft for the committed ForumPost constructor actor user ID state validation fix.
...
- [718-pr-validate-site-invite-action-status-type.md](718-pr-validate-site-invite-action-status-type.md): upstream PR draft for the committed site-invitation action status type validation fix.
...
- [732-pr-validate-finite-amc-and-requestutil-numeric-controls.md](732-pr-validate-finite-amc-and-requestutil-numeric-controls.md): upstream PR draft for the committed finite AMC and direct URL numeric-control validation fix.
...
- [759-pr-validate-recent-change-revision-cell-ascii-shape.md](759-pr-validate-recent-change-revision-cell-ascii-shape.md): upstream PR draft for the committed recent-change revision cell ASCII-shape validation fix.
...
- [764-pr-validate-quickmodule-user-id-ascii-shape.md](764-pr-validate-quickmodule-user-id-ascii-shape.md): upstream PR draft for the committed QuickModule user ID ASCII-shape validation fix.
...
- [785-pr-validate-page-edit-retained-title.md](785-pr-validate-page-edit-retained-title.md): upstream PR draft for the committed page edit retained-title validation fix.
- [786-pr-validate-page-edit-retained-fullname.md](786-pr-validate-page-edit-retained-fullname.md): upstream PR draft for the committed page edit retained-fullname validation fix.
- [787-pr-validate-page-edit-retained-page-id.md](787-pr-validate-page-edit-retained-page-id.md): upstream PR draft for the committed page edit retained page-ID validation fix.
...
- [812-pr-validate-forum-category-create-response-payload.md](812-pr-validate-forum-category-create-response-payload.md): upstream PR draft for the committed forum category create response-payload validation fix.
- [813-pr-validate-forum-thread-reply-response-payload.md](813-pr-validate-forum-thread-reply-response-payload.md): upstream PR draft for the committed forum thread reply response-payload validation fix.
- [814-pr-validate-forum-post-edit-response-payload.md](814-pr-validate-forum-post-edit-response-payload.md): upstream PR draft for the committed forum post edit response-payload validation fix.
- [815-pr-validate-site-invite-response-payload.md](815-pr-validate-site-invite-response-payload.md): upstream PR draft for the committed site invitation response-payload validation fix.
...
- [852-pr-validate-site-member-action-response-count.md](852-pr-validate-site-member-action-response-count.md): upstream PR draft for the committed site member action response-count validation fix.
...
- Local implementation commits, continued 594: `cf27a37 fix(site_application): validate constructor user id range`
- Local implementation commits, continued 595: `265813d fix(site_member): validate constructor user id range`
- Local implementation commits, continued 596: `608a773 fix(page_votes): validate constructor vote user ids`
- Local implementation commits, continued 597: `bf48298 fix(private_message): validate constructor participant user ids`
- Local implementation commits, continued 598: `8a6fcbd fix(site): validate site change actor user ids`
- Local implementation commits, continued 599: `4e4a3e0 fix(page_revision): validate creator user ids`
- Local implementation commits, continued 600: `4e3d1d0 fix(forum_thread): validate creator user ids`
- Local implementation commits, continued 601: `7a82c42 fix(forum_post): validate actor user ids`
...
- Local implementation commits, continued 623: `e247364 fix(site): validate invite status type`
...
- Local implementation commits, continued 637: `cecc882 fix(http): validate finite request numeric controls`
...
- Local implementation commits, continued 664: `a72e0bc fix(site): validate recent change revision number shape`
...
- Local implementation commits, continued 669: `04a8af2 fix(quickmodule): validate user id ascii shape`
...
- Local implementation commits, continued 690: `6948429 fix(page): validate retained edit title`
- Local implementation commits, continued 691: `e2b929d fix(page): validate retained edit fullname`
- Local implementation commits, continued 692: `5d903b7 fix(page): validate retained edit page id`
...
- Local implementation commits, continued 717: `0d4ad1a fix(forum_category): validate create response payload`
- Local implementation commits, continued 718: `678a8c1 fix(forum_thread): validate reply response payload`
- Local implementation commits, continued 719: `ad6b066 fix(forum_post): validate edit response payload`
- Local implementation commits, continued 720: `1a7591e fix(site): validate invite response payload`
...
- Local implementation commits, continued 735: `404a5c9 fix(site_member): validate action response count`
