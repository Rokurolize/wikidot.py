...
for result in site.pages.iter_sources(
    ...
    if result.ok:
        write_source(result.fullname, result.wiki_text)
    else:
        record_failure(result.fullname, result.error_message)
```

## Alternatives Considered

- Keep requiring callers to manage offsets, source batches, and exact tag filters manually. Local commit `9f7b2da` removes the repeated offset loop for page discovery through `site.pages.iter_search(...)`, local commit `9d82979` adds `site.pages.iter_sources(...)` with source batch fallback, local commit `52cf6ce` keeps fallback active even when the fallback batch size is larger than the primary batch, local commit `5982ad7` rejects invalid pagination values before they reach ListPages request construction, local commit `988bbea` includes page names in source failure messages, local commit `3a4d63c` keeps malformed source responses from aborting the whole source iterator, local commit `68b7d8f` lets callers read successful source text directly from `PageSourceResult.wiki_text`, local commit `b5d13b3` lets the iterators apply exact required-tag filtering against parsed `Page.tags` before yielding pages or fetching source, local commit `018bb43` preserves later valid source responses in a mixed parse-failure batch so the iterator avoids redundant fallback requests, local commit `f92d473` exposes ledger-friendly source result context through `PageSourceResult.fullname` and `PageSourceResult.error_message`, and local commit `ae4d210` lets callers export those source result fields as compact ledger dictionaries through `PageSourceResult.as_dict()`.
...
The first iterator slice is drafted in [018-pr-bounded-page-search-iterator.md](018-pr-bounded-page-search-iterator.md), the source iterator/fallback slice is drafted in [019-pr-page-source-iterator-fallback.md](019-pr-page-source-iterator-fallback.md), the fallback batch-size fix is drafted in [022-pr-source-iterator-large-fallback-batch.md](022-pr-source-iterator-large-fallback-batch.md), the pagination validation fix is drafted in [023-pr-search-pagination-validation.md](023-pr-search-pagination-validation.md), the source failure context fix is drafted in [025-pr-source-result-error-page-context.md](025-pr-source-result-error-page-context.md), the source parse failure isolation fix is drafted in [026-pr-source-iterator-parse-failure-isolation.md](026-pr-source-iterator-parse-failure-isolation.md), the source result wiki text fix is drafted in [027-pr-source-result-wiki-text.md](027-pr-source-result-wiki-text.md), the required-tag iterator filter is drafted in [049-pr-filter-iterators-by-required-tags.md](049-pr-filter-iterators-by-required-tags.md), the source batch success preservation fix is drafted in [051-pr-preserve-source-batch-successes.md](051-pr-preserve-source-batch-successes.md), the source result context property fix is drafted in [052-pr-source-result-context-properties.md](052-pr-source-result-context-properties.md), and the source result ledger-record helper is drafted in [069-pr-source-result-ledger-record.md](069-pr-source-result-ledger-record.md). The small local PR drafts in [002-pr-batch-source-page-id-lookups.md](002-pr-batch-source-page-id-lookups.md), [005-pr-bound-listpages-pagination-by-limit.md](005-pr-bound-listpages-pagination-by-limit.md), [006-pr-retry-batched-source-fetches.md](006-pr-retry-batched-source-fetches.md), [008-pr-skip-cached-source-fetches.md](008-pr-skip-cached-source-fetches.md), [009-pr-skip-cached-page-detail-fetches.md](009-pr-skip-cached-page-detail-fetches.md), [010-pr-retry-batched-file-fetches.md](010-pr-retry-batched-file-fetches.md), [014-pr-preserve-viewsource-text.md](014-pr-preserve-viewsource-text.md), [015-pr-retry-revision-source-html-fetches.md](015-pr-retry-revision-source-html-fetches.md), [016-pr-retry-listpages-pagination.md](016-pr-retry-listpages-pagination.md), [018-pr-bounded-page-search-iterator.md](018-pr-bounded-page-search-iterator.md), [019-pr-page-source-iterator-fallback.md](019-pr-page-source-iterator-fallback.md), [022-pr-source-iterator-large-fallback-batch.md](022-pr-source-iterator-large-fallback-batch.md), [023-pr-search-pagination-validation.md](023-pr-search-pagination-validation.md), [025-pr-source-result-error-page-context.md](025-pr-source-result-error-page-context.md), [026-pr-source-iterator-parse-failure-isolation.md](026-pr-source-iterator-parse-failure-isolation.md), [027-pr-source-result-wiki-text.md](027-pr-source-result-wiki-text.md), [049-pr-filter-iterators-by-required-tags.md](049-pr-filter-iterators-by-required-tags.md), [051-pr-preserve-source-batch-successes.md](051-pr-preserve-source-batch-successes.md), [052-pr-source-result-context-properties.md](052-pr-source-result-context-properties.md), and [069-pr-source-result-ledger-record.md](069-pr-source-result-ledger-record.md) are immediate performance, reliability, and ergonomics improvements for this feature area.
